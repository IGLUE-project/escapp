...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        for (const asset of assets) {
            ...
            //Download file
            try {
                let downloadFileName = path.basename(new URL(asset.url).pathname);
                ...
                let assetFileId = "cloudinary-" + asset.id + "-" + downloadFileName;
                let assetFilePath = "/uploads/" + assetFileId;
                let assetFilePathFull = destAssetsFolder + "/" + assetFileId;
