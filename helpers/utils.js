    ...
    try {
        switch(puzzleValidator){
            ...
            case "regex":
                ...
                break;
            case "range":
                const splitArray  = puzzleSol.toString().split("+")[1]
                const solution = splitArray[0];
                const range = splitArray[1];
                correctAnswer = (answer > solution - range ) && (answer < solution + range );
                break;
